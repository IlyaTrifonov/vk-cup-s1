...
export const darkThemeColors = {
    ...
    Jacarta: 'var(--colorCommonJacarta)',
...
export const lightThemeColors = {
    ...
    Eggshell: 'var(--colorCommonEggshell)',
    Water: 'var(--colorCommonWater)',
    LavenderBlue: 'var(--colorCommonLavenderBlue)',
    AzureishWhite: 'var(--colorCommonAzureishWhite)',
    AntiFlashWhite: 'var(--colorCommonAntiFlashWhite)'
}